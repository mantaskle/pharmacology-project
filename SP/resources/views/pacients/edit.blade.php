...
<div class="row">
 <div class="col-md-12">
  ...
  <form method="post" action="{{action('PacientsController@update', $id)}}">
   ...
   <div class="form-group">
    <label style="color: #ffffff" for="additional_information">Papildoma informacija:</label>
